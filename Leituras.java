...
/*
    ...
    DETALHE: O Scanner utiliza como idioma padrão, o idioma da máquina. Isso significa que por exemplo, ao usuario digitar um numero real (double ou float), o separador de casas decimais é o do idioma padrão ( no nosso caso, português do Brasil, é a vírgula - ,).
*/
